...
exports.getMyMatches = async (req, res) => {
  try {
    ...
    .populate('user1Id', 'displayName photos age bio occupation location height interests relationshipExpectations isVerified isPremium gender education drinking smoking drugs')
    .populate('user2Id', 'displayName photos age bio occupation location height interests relationshipExpectations isVerified isPremium gender education drinking smoking drugs')
    ...
    const formattedMatches = await Promise.all(matches.map(async (match) => {
      ...
      return {
        ...
        user: {
          ...
          image: otherUser.photos && otherUser.photos[0] ? otherUser.photos[0] : null,
          ...
          relationshipExpectations: otherUser.relationshipExpectations || 'Open to possibilities',
