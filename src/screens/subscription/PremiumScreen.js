...
const makeStyles = (colors) => StyleSheet.create({
  ...
  tierTabActive: { backgroundColor: colors.card, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 4, elevation: 2 },
  tierTabText: { fontSize: 15, fontWeight: '600', color: colors.text.secondary },
  ...
  planCardSelected: { borderColor: '#B8860B', backgroundColor: colors.surface },
  planPeriod: { fontSize: 13, fontWeight: '600', color: colors.text.tertiary, marginBottom: 4 },
  planPeriodSelected: { color: '#B8860B' },
  planPrice: { fontSize: 22, fontWeight: '800', color: colors.text.primary },
  planPriceSelected: { color: '#7A5C00' },
  planBillingPeriod: { fontSize: 12, color: colors.text.tertiary, marginTop: 2 },
  ...
  featureText: { flex: 1 },
  featureLabel: { fontSize: 15, fontWeight: '600', color: colors.text.primary },
  featureDesc: { fontSize: 12, color: colors.text.secondary, marginTop: 1 },
  ...
  skipBtnText: { fontSize: 15, fontWeight: '500', color: colors.text.tertiary },
  legal: { fontSize: 11, color: colors.text.tertiary, textAlign: 'center', lineHeight: 16, marginTop: 16 },
  ...
  activeTitle: { fontSize: 26, fontWeight: '800', color: colors.text.primary, textAlign: 'center', marginBottom: 4 },
  activeSubtitle: { fontSize: 14, color: colors.text.secondary, textAlign: 'center', marginBottom: 28 },
  activeFeatureList: {
    backgroundColor: colors.card,
    borderRadius: 16,
    padding: 8,
